...
BUILDDIR32=/home/pi/RebelServer/src/client/node_modules/jpegtran-bin/92b51214-f5bf-416e-8d56-8fd4d2a1758c/osxx86
BUILD32=0
BUILDDIRARMV6=/home/pi/RebelServer/src/client/node_modules/jpegtran-bin/92b51214-f5bf-416e-8d56-8fd4d2a1758c/iosarmv6
BUILDARMV6=0
BUILDDIRARMV7=/home/pi/RebelServer/src/client/node_modules/jpegtran-bin/92b51214-f5bf-416e-8d56-8fd4d2a1758c/iosarmv7
BUILDARMV7=0
BUILDDIRARMV7S=/home/pi/RebelServer/src/client/node_modules/jpegtran-bin/92b51214-f5bf-416e-8d56-8fd4d2a1758c/iosarmv7s
BUILDARMV7S=0
BUILDDIRARMV8=/home/pi/RebelServer/src/client/node_modules/jpegtran-bin/92b51214-f5bf-416e-8d56-8fd4d2a1758c/iosarmv8
BUILDARMV8=0
WITH_JAVA=0
LIPO=lipo
...
if [ $BUILDARMV6 = 1 ]; then
	...
	popd
	if [ ! -h $TMPDIR/dist.armv6/$LIBDIR/libjpeg.62.dylib -a \
		! -h $PKGROOT/$LIBDIR/libjpeg.62.dylib ]; then
		$LIPO -create \
			$PKGROOT/$LIBDIR/libjpeg.62.dylib \
			-arch arm $TMPDIR/dist.armv6/$LIBDIR/libjpeg.62.dylib \
			-output $PKGROOT/$LIBDIR/libjpeg.62.dylib
	elif [ ! -h $TMPDIR/dist.armv6/$LIBDIR/libjpeg.62.0.0.dylib -a \
		! -h $PKGROOT/$LIBDIR/libjpeg.62.0.0.dylib ]; then
		$LIPO -create \
			$PKGROOT/$LIBDIR/libjpeg.62.0.0.dylib \
			-arch arm $TMPDIR/dist.armv6/$LIBDIR/libjpeg.62.0.0.dylib \
			-output $PKGROOT/$LIBDIR/libjpeg.62.0.0.dylib
	fi
	$LIPO -create \
...
if [ $BUILDARMV7 = 1 ]; then
	...
	popd
	if [ ! -h $TMPDIR/dist.armv7/$LIBDIR/libjpeg.62.dylib -a \
		! -h $PKGROOT/$LIBDIR/libjpeg.62.dylib ]; then
		$LIPO -create \
			$PKGROOT/$LIBDIR/libjpeg.62.dylib \
			-arch arm $TMPDIR/dist.armv7/$LIBDIR/libjpeg.62.dylib \
			-output $PKGROOT/$LIBDIR/libjpeg.62.dylib
	elif [ ! -h $TMPDIR/dist.armv7/$LIBDIR/libjpeg.62.0.0.dylib -a \
		! -h $PKGROOT/$LIBDIR/libjpeg.62.0.0.dylib ]; then
		$LIPO -create \
			$PKGROOT/$LIBDIR/libjpeg.62.0.0.dylib \
			-arch arm $TMPDIR/dist.armv7/$LIBDIR/libjpeg.62.0.0.dylib \
			-output $PKGROOT/$LIBDIR/libjpeg.62.0.0.dylib
	fi
	$LIPO -create \
		$PKGROOT/$LIBDIR/libjpeg.a \
...
if [ $BUILDARMV7S = 1 ]; then
	...
	popd
	if [ ! -h $TMPDIR/dist.armv7s/$LIBDIR/libjpeg.62.dylib -a \
		! -h $PKGROOT/$LIBDIR/libjpeg.62.dylib ]; then
		$LIPO -create \
			$PKGROOT/$LIBDIR/libjpeg.62.dylib \
			-arch arm $TMPDIR/dist.armv7s/$LIBDIR/libjpeg.62.dylib \
			-output $PKGROOT/$LIBDIR/libjpeg.62.dylib
	elif [ ! -h $TMPDIR/dist.armv7s/$LIBDIR/libjpeg.62.0.0.dylib -a \
		! -h $PKGROOT/$LIBDIR/libjpeg.62.0.0.dylib ]; then
		$LIPO -create \
			$PKGROOT/$LIBDIR/libjpeg.62.0.0.dylib \
			-arch arm $TMPDIR/dist.armv7s/$LIBDIR/libjpeg.62.0.0.dylib \
			-output $PKGROOT/$LIBDIR/libjpeg.62.0.0.dylib
	fi
	$LIPO -create \
		$PKGROOT/$LIBDIR/libjpeg.a \
...
if [ $BUILDARMV8 = 1 ]; then
	...
	popd
	if [ ! -h $TMPDIR/dist.armv8/$LIBDIR/libjpeg.62.dylib -a \
		! -h $PKGROOT/$LIBDIR/libjpeg.62.dylib ]; then
		$LIPO -create \
			$PKGROOT/$LIBDIR/libjpeg.62.dylib \
			-arch arm64 $TMPDIR/dist.armv8/$LIBDIR/libjpeg.62.dylib \
			-output $PKGROOT/$LIBDIR/libjpeg.62.dylib
	elif [ ! -h $TMPDIR/dist.armv8/$LIBDIR/libjpeg.62.0.0.dylib -a \
		! -h $PKGROOT/$LIBDIR/libjpeg.62.0.0.dylib ]; then
		$LIPO -create \
			$PKGROOT/$LIBDIR/libjpeg.62.0.0.dylib \
			-arch arm64 $TMPDIR/dist.armv8/$LIBDIR/libjpeg.62.0.0.dylib \
			-output $PKGROOT/$LIBDIR/libjpeg.62.0.0.dylib
	fi
	$LIPO -create \
		$PKGROOT/$LIBDIR/libjpeg.a \
